...
export function resolverFila(catalogo: Catalogo, r: Fila, m: Mapas): Resuelto {
  ...
  switch (catalogo) {
    ...
    case "umbrales_ocio_puesto":
      // Son cuatro filas y un error de captura desordena la lectura del Gantt: se
      // gestionan solo en Administracion.
      return { error: "los umbrales de tiempo sin viaje no se importan por CSV" };
